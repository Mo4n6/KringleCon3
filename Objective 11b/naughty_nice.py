...
class Block():
   ...
   #new function to calculate SHA256 of the full block
...
if __name__ == '__main__':
    ...
    for i in range(len(c2.blocks)):
        ...
        if (c2.blocks[i].full_hash_SHA256() ==targetBlock_SHA256):
            ...
            print(c2.blocks[i])
            print("Block [",i,"].index:",c2.blocks[i].index)
            print("Block [",i,"].hash:",c2.blocks[i].hash)
            print("Block [",i,"] Calculated Hash (MD5)", c2.blocks[i].hash_block())
            print("Block [",i,"] Calculated Hash (SHA256)", c2.blocks[i].hash_SHA256_block())
            print("Block [",i,"].previous_hash", c2.blocks[i].previous_hash)
            print("Block [",i,"] signed Hash(MD5)", c2.blocks[i].full_hash())
            print("Block [",i,"] signed Hash (SHA256)", c2.blocks[i].full_hash_SHA256())
            print("===========")
            print(c2.blocks[i])
            print("===========")
